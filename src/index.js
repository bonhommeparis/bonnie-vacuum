 ...
 * Inspired from https://github.com/watsondg/sniffer
 */
class Vacuum {
  ...
  addClasses(el = null) {
    ...
    Object.keys(this._infos).forEach((info) => {
      if (this._infos[info] === true) this._addClass(el, this._toDash(info));
    }, this);
  }
  ...
  _parse() {
    ...
    const isChrome = window.chrome !== null && window.chrome !== undefined && window.navigator.vendor.toLowerCase() === 'google inc.' && !isOpera && !isEdge;
